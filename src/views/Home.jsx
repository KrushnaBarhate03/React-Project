...
function Home() {
  return(
    <>
    <div>
      <h3 className='text-center font-serif font-bold text-lg sm:text-2xl text-orange-500 mt-3'>See the World from a Higher Perspective.</h3>
    ...
    <div className="">
      <h3 className="text-center font-serif font-bold text-xl w-auto sm:w-120 mx-auto mt-6 bg-amber-500"> Our Drones</h3> 
       ...
       <div className="flex flex-row sm:mt-10 m-6 flex-wrap">
